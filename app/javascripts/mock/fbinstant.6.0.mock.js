...
var FBInstant = {
    ...
    player : {
        ...
        getPhoto: function() {
            return Utils.returnUserData('/images/mock/profile.jpg');
        },
        getID: function() {
                    ...
                    players = [
                        {
                            ...
                            getPhoto: function() { '/images/mock/friend1.png'}
                        },
                        {
                            getID: function() { return 43 },
                            getName: function() { return 'Friend 2' },
                            getPhoto: function() { '/images/mock/friend2.png'}
                        },
                        {
                            getID: function() { return 44 },
                            getName: function() { return 'Friend 3' },
                            getPhoto: function() { '/images/mock/friend3.png'}
                        },
                    ];
                } else {
    ...
    initializeAsync: function() {
        return new Promise(function(resolve, reject){
            ...
            stylesheet.href = '/stylesheets/mock/mock.css';
