...
window.addEventListener('DOMContentLoaded', function() {
  ...
  var apiURL = 'http://localhost/christianaugustyn/search/web/direct_search.php?ajax=1&q=';
  ...
  function onRequestLoad() {
    ...
    if(documents.length === 0) {
      ...
      documents.forEach(function(doc) {
        ...
        docLink.textContent = doc.story;//doc.title;
        docLink.href = "http://localhost/christianaugustyn/ajax/post.php?id="+doc.id;//doc.url;
